        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
          ...
          <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-28">
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-2">
              {/* Assessoria Card */}
              <div className="group relative overflow-hidden rounded-3xl border-2 border-red-400/40 bg-gradient-to-br from-red-900/40 via-slate-800/60 to-slate-900/80 p-8 shadow-2xl shadow-red-500/20 backdrop-blur-sm transition-all duration-300 hover:border-red-400/60 hover:shadow-red-500/30">
                ...
                <div className="relative">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-semibold text-slate-200">Assessoria de Corrida</h3>
                  </div>
                  <div className="mb-6">
                    <p className="text-sm text-slate-400 mb-2">Custo mensal:</p>
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-red-300">R$ 150</span>
                      <span className="text-xl text-slate-400">a</span>
                      <span className="text-5xl font-bold text-red-300">R$ 350</span>
                    </div>
                    <p className="text-sm text-slate-400 mt-2">por mês</p>
                  </div>
                </div>
              </div>

              {/* Treinador Particular Card */}
              <div className="group relative overflow-hidden rounded-3xl border-2 border-orange-400/40 bg-gradient-to-br from-orange-900/40 via-slate-800/60 to-slate-900/80 p-8 shadow-2xl shadow-orange-500/20 backdrop-blur-sm transition-all duration-300 hover:border-orange-400/60 hover:shadow-orange-500/30">
                ...
                <div className="relative">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-semibold text-slate-200">Treinador Particular</h3>
                  </div>
                  <div className="mb-6">
                    <p className="text-sm text-slate-400 mb-2">Custo mensal:</p>
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-orange-300">R$ 1.000</span>
                      <span className="text-xl text-slate-400">a</span>
                      <span className="text-5xl font-bold text-orange-300">R$ 3.000</span>
                    </div>
                    <p className="text-sm text-slate-400 mt-2">por mês</p>
                  </div>
                </div>
