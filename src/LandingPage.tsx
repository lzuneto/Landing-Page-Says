  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main>
        ...
        <section id="hero" className="relative overflow-hidden bg-gradient-to-b from-slate-100/70 via-white to-sky-50/40">
          ...
          <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 pt-6 sm:pt-7 lg:pt-10 pb-8 sm:pb-10 lg:pb-14">
            <div className="flex flex-col items-center text-center">
              {/* Headline: trio equilibrado – mais compacto */}
              ...
              {/* CTA: forte mas não dominante – mais próximo do mockup */}
              ...
              {/* Mockup: espaço harmonioso entre CTA e card */}
        ...
        {ACTIVE_VARIANT === 'variantD' && (
          <section id="identificacao" className="relative overflow-hidden bg-white">
            <div className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-8 sm:pt-10 md:pt-12 lg:pt-14 pb-6 sm:pb-8 md:pb-10 lg:pb-12">
              ...
              {/* Conclusão movida para seção minimalista dedicada (bloco "Nosso aplicativo...") */}
            </div>
          </section>
        )}

        {/* Variant D – "Nosso aplicativo foi criado para você": pausa minimalista – sem card, só ícone + texto */}
        {ACTIVE_VARIANT === 'variantD' && (
        ...
        {/* Variant D – Uma plataforma pensada…: premium, compacta, linha divisória sutil */}
        {ACTIVE_VARIANT === 'variantD' && (
        ...
        {/* Cópia Acesso Antecipado – variant D: seção exclusiva, fundo diferenciado, badge em destaque, CTA dominante */}
        {ACTIVE_VARIANT === 'variantD' && (
        ...
        {/* Quem somos – variant D: estilo mais editorial, cards mais compactos */}
        {((ACTIVE_VARIANT === 'variantA' || ACTIVE_VARIANT === 'variantD') || ACTIVE_VARIANT === 'variantC') && (
        <section id="quem-somos" className={`relative overflow-hidden ${ACTIVE_VARIANT === 'variantD' ? 'bg-slate-50/60' : 'bg-gradient-to-b from-white via-slate-50 to-white'}`}>
          <div className={`mx-auto max-w-6xl px-4 sm:px-6 ${ACTIVE_VARIANT === 'variantD' ? 'pt-16 sm:pt-20 lg:pt-24 pb-10 sm:pb-12 lg:pb-14' : 'py-16 sm:py-20 md:py-24 lg:py-28'}`}>
            {/* Header */}
            <div className={ACTIVE_VARIANT === 'variantD' ? 'mb-10 sm:mb-12' : 'mb-12 sm:mb-16'}>
              ...
              {/* Texto introdutório – variant D: cards mais estreitos, menos padding, ritmo vertical */}
              <div className={ACTIVE_VARIANT === 'variantD' ? 'mx-auto max-w-4xl' : 'mx-auto max-w-5xl'}>
                <div className={ACTIVE_VARIANT === 'variantD' ? 'space-y-4 sm:space-y-5 md:space-y-6' : 'space-y-4 sm:space-y-6 md:space-y-8'}>
                  {/* Frase 1 */}
                  <div className={`group relative overflow-hidden border border-slate-200 bg-white transition-colors duration-200 hover:border-slate-300 ${ACTIVE_VARIANT === 'variantD' ? 'rounded-lg p-4 sm:p-5 md:p-6' : 'rounded-xl sm:rounded-2xl bg-gradient-to-br from-white to-sky-50/30 shadow-md transition-all duration-300 hover:shadow-xl hover:border-sky-300 sm:p-6 md:p-8'}`}>
                    <div className={`relative flex items-start gap-3 sm:gap-4 ${ACTIVE_VARIANT === 'variantD' ? '' : ''}`}>
                      <div className={`flex-shrink-0 flex items-center justify-center text-white font-bold ${ACTIVE_VARIANT === 'variantD' ? 'w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-sky-600 text-lg' : 'w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-sky-500 to-green-500 text-lg sm:text-xl md:text-2xl shadow-lg'}`}>
                        1
                      </div>
                  ...
                  <div className={`group relative overflow-hidden border border-slate-200 bg-white transition-colors duration-200 hover:border-slate-300 ${ACTIVE_VARIANT === 'variantD' ? 'rounded-lg p-4 sm:p-5 md:p-6' : 'rounded-xl sm:rounded-2xl bg-gradient-to-br from-white to-green-50/30 shadow-md transition-all duration-300 hover:shadow-xl hover:border-green-300 sm:p-6 md:p-8'}`}>
                    <div className="relative flex items-start gap-3 sm:gap-4">
                      <div className={`flex-shrink-0 flex items-center justify-center text-white font-bold ${ACTIVE_VARIANT === 'variantD' ? 'w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-sky-600 text-lg' : 'w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-green-500 to-sky-500 text-lg sm:text-xl md:text-2xl shadow-lg'}`}>
                        2
                      </div>
                      <p className="text-base sm:text-lg md:text-xl text-slate-900 leading-relaxed font-medium pt-0.5 sm:pt-1 min-w-0">
                  ...
                  {/* Frase 3 */}
                  <div className={`group relative overflow-hidden border border-slate-200 bg-white transition-colors duration-200 hover:border-slate-300 ${ACTIVE_VARIANT === 'variantD' ? 'rounded-lg p-4 sm:p-5 md:p-6' : 'rounded-xl sm:rounded-2xl bg-gradient-to-br from-white via-sky-50/20 to-green-50/20 shadow-md transition-all duration-300 hover:shadow-xl hover:border-sky-300 sm:p-6 md:p-8'}`}>
                    <div className="relative flex items-start gap-3 sm:gap-4">
                      <div className={`flex-shrink-0 flex items-center justify-center text-white font-bold ${ACTIVE_VARIANT === 'variantD' ? 'w-10 h-10 sm:w-11 sm:h-11 rounded-lg bg-sky-600 text-lg' : 'w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-sky-600 to-green-600 text-lg sm:text-xl md:text-2xl shadow-lg'}`}>
                        3
                      </div>
                      <p className="text-base sm:text-lg md:text-xl text-slate-900 leading-relaxed font-medium pt-0.5 sm:pt-1 min-w-0">
            ...
            {/* Grid – variant D: mais compacto, fotos mais próximas do texto */}
            <div className={ACTIVE_VARIANT === 'variantD' ? 'mt-10 sm:mt-12' : 'mt-12 sm:mt-16'}>
              <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 ${ACTIVE_VARIANT === 'variantD' ? 'gap-3 sm:gap-4 md:gap-5' : ''}`}>
        ...
        {/* CTA final – variant D: mais respiro, CTA maior, leve contraste antes do footer */}
        {ACTIVE_VARIANT === 'variantD' && (
      ...
      {/* Footer – variant D: fundo mais escuro, separação clara do conteúdo */}
      <footer className={`border-t border-slate-200 ${ACTIVE_VARIANT === 'variantD' ? 'bg-slate-200/50' : 'bg-slate-50/50'}`}>
